...
#Parameters
R = 0.0485 #97/2/1000 #unit:meter wheelradius
TPR = 1320 #11*30*4
thetaPtick=0.00476 #(2*math.pi)/TPR
L1=0.108 #unit:meter
L2=0.0807 #unit:meter
LF_ticks = 0
RF_ticks = 0
LR_ticks = 0
RR_ticks = 0
...
LF_ticks_sub =rospy.Subscriber("/LF_encoder", Int32, LFCB,queue_size=1,buff_size=65536)
RF_ticks_sub =rospy.Subscriber("/RF_encoder", Int32, RFCB,queue_size=1,buff_size=65536)
LR_ticks_sub =rospy.Subscriber("/LR_encoder", Int32, LRCB,queue_size=1,buff_size=65536)
RR_ticks_sub =rospy.Subscriber("/RR_encoder", Int32, RRCB,queue_size=1,buff_size=65536)
